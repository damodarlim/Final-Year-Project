        ...
        <div class="row my-4">
            <div class="col-lg-8">
                ...
                <div class="post-container">
                    ...
                    if(isset($_GET['cid'])){ // if the user clicks on the aid then this runs
                        $cat_id = $_GET['cid'];
                    }

                    $sql1 = "SELECT * FROM category_table WHERE category_id = {$cat_id}";
                    ...
                    WHERE news_table.category = {$cat_id}
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1){
                            echo '<li><a href="author.php?aid='.$cat_id.'&page='.($page - 1).'">Prev</a></li>';                        
                        }
                        for($i = 1; $i <= $total_page; $i++){  
                            ...
                            echo '<li class="'.$active.'"><a href="author.php?aid='.$cat_id.'&page='.$i.'">'.$i.'</a></li>';
                        }
                        if ($total_page > $page){
                            echo '<li><a href="author.php?aid='.$cat_id.'&page='.($page + 1).'">Next</a></li>';                
                        }
                        echo '</ul>';
                    } else {
