        ...
        <div class="row my-4">
            <div class="col-lg-8">
                ...
                <div class="post-container">
                    ...
                    if(isset($_GET['aid'])){ // if the user clicks on the aid then this runs
                        $auth_id = $_GET['aid'];
                    }

                    $sql1 = "SELECT * FROM news_table JOIN member_table
                            ON news_table.author= member_table.member_id
                            WHERE news_table.author = {$auth_id}";
